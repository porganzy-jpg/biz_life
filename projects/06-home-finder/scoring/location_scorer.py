"""
위치 점수 (0~100)
- 지하철 거리 (40%): <400m=100, <800m=80, <1200m=50
- 한강 거리 (25%): <500m=100, <1km=80, <2km=50
- 공원 거리 (20%): <300m=100, <800m=70
...
class LocationScorer:
    ...
    def __init__(self, subway_stations: list, parks: list, river_points: list):
